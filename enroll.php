...
if($param1 != "" && $param1 != "All"){
	$result = mysqli_query($conn,"SELECT c.c_id as id, c.c_no as cnum, c.s_no as snum, c.c_name as cname, c.descr as descr, d.dname as dname,p.prereq as pid FROM course_details c,department d, course_term_assignment t, pre_req p WHERE c.d_id = d.d_id and d.d_id='$param1' and c.c_id = t.c_id and c.c_id = p.c_id and t.term_id = '$term_id' and t.status = '1'");
} else {
